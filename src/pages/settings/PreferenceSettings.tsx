...
import { Sun, Moon, Monitor, Palette, Check, Globe2, Loader2 } from 'lucide-react';
    ...
    <div className="space-y-10">
      ...
      <section className="bg-white rounded-2xl border border-zinc-200 p-8">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h3 className="text-xl font-bold text-zinc-900">Idioma</h3>
            <p className="text-sm text-zinc-500">Elige el idioma de la interfaz de la plataforma.</p>
          </div>
        </div>
        ...
        <div className="max-w-sm">
          <div className="relative">
            <select
              ...
              disabled={savingLang}
              className="w-full p-3 pl-12 rounded-lg border border-zinc-200 focus:ring-2 focus:ring-[#6C5DD3] focus:border-transparent outline-none transition-all appearance-none font-bold text-zinc-900 disabled:opacity-70 cursor-pointer"
            >
              {LANGUAGES.map(l => (
          ...
          <p className="text-xs text-zinc-400 mt-2">Los cambios de idioma se aplicarán en la próxima sesión.</p>
        </div>
      </section>
    </div>
  );
